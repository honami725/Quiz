...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["女子ラクロスは\n1チーム何人で\n行う競技？","10人","11人","12人",3])
        tmpArray.append(["ゴールキーパーのことを\nなんと呼ぶ？","ゴーラー","ゴーリー","ゴールマン",2])
        tmpArray.append(["プレイヤーが使う\nスティックのことを\nなんて呼ぶ？","ラケット","ネット","クロス",3])
        tmpArray.append(["女子ラクロスで\n身につけないものは\nこの中でどれ？","ヘルメット","マウスピース","グローブ",1])
        tmpArray.append(["日本で一番初めに\nラクロスチームを作った\n大学はどこ？","東京大学","慶應義塾大学","早稲田大学",2])
        tmpArray.append(["ラクロスが出てくる\nジブリ作品はどれ？","猫の恩返し","思い出のマーニー","崖の上のポニョ",1])
