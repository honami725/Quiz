...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["女子ラクロスは1チーム何人で構成されて行う競技？","10人","11人","12人",3])
        tmpArray.append(["ゴールキーパーのことをなんと呼ぶ？","ゴーラー","ゴーリー","ゴールマン",2])
        tmpArray.append(["ラクロスでプレイヤーが使うスティックのことをなんて呼ぶ？","ラケット","ネット","クロス",3])
        tmpArray.append(["女子ラクロスでプレイ中に身につけないものはこの中でどれ？","ヘルメット","マウスピース","グローブ",1])
        tmpArray.append(["日本で一番初めにラクロスチームを結成した大学はどこ？","東京大学","慶應大学","早稲田大学",2])
        tmpArray.append(["ラクロスが出てくるジブリ作品はどれ？","猫の恩返し","思い出のマーニー","崖の上のポニョ",1])
